...
const Kitoblar: React.FC = () => {
  ...
  return (
    <div
      className={`min-h-screen p-5 ${isDarkMode ? "bg-[#1E1E1E] text-[#FDF7F5]" : "bg-[#fff] text-[#5B2C25]"
        }`}
    >
      <div className="max-w-full lg:max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
          <div className="flex flex-wrap gap-2">
            <button
              className={`px-3 sm:px-4 py-2 rounded text-sm sm:text-base cursor-pointer ${busy === null
            ...
            <button
              className={`px-3 sm:px-4 py-2 rounded text-sm sm:text-base cursor-pointer ${busy === false
            ...
            <button
              className={`px-3 sm:px-4 py-2 rounded text-sm sm:text-base cursor-pointer ${busy === true
                ? "bg-[#773000] text-white"
                : "bg-gray-300 text-black"
                }`}
